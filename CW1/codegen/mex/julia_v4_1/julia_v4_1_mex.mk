...
MAKEFILE = julia_v4_1_mex.mk

include julia_v4_1_mex.mki
...
SRC_FILES =  \
	...
	power.c \
	julia_v4_1_api.c \
	julia_v4_1_emxutil.c \
	julia_v4_1_mex.c \
	_coder_julia_v4_1_info.c

MEX_FILE_NAME_WO_EXT = julia_v4_1_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/julia_v4_1"
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/julia_v4_1/interface"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/julia_v4_1/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/julia_v4_1/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/julia_v4_1/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
