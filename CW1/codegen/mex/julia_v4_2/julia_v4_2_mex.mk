...
MAKEFILE = julia_v4_2_mex.mk

include julia_v4_2_mex.mki
...
SRC_FILES =  \
	...
	julia_v4_2.c \
	julia_v4_2_api.c \
	julia_v4_2_emxutil.c \
	julia_v4_2_mex.c \
	_coder_julia_v4_2_info.c

MEX_FILE_NAME_WO_EXT = julia_v4_2_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/julia_v4_2"
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/julia_v4_2/interface"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/julia_v4_2/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/julia_v4_2/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/julia_v4_2/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
