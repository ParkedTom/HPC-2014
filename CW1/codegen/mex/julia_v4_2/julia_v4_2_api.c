 ...
 * julia_v4_2_api.c
 *
 * Code generation for function 'julia_v4_2_api'
 *
...
static emlrtRTEInfo b_emlrtRTEI = { 1, 1, "julia_v4_2_api", "" };
...
void julia_v4_2_api(emlrtStack *sp, const mxArray * const prhs[3], const mxArray
                    *plhs[2])
{
  emxArray_creal_T *vz;
  ...
  julia_v4_2(sp, vz, c, maxiter, iter);
...
/* End of code generation (julia_v4_2_api.c) */
