...
MAKEFILE = julia_v4_3_mex.mk

include julia_v4_3_mex.mki
...
SRC_FILES =  \
	...
	power.c \
	julia_v4_3_api.c \
	julia_v4_3_emxutil.c \
	julia_v4_3_mex.c \
	_coder_julia_v4_3_info.c

MEX_FILE_NAME_WO_EXT = julia_v4_3_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/julia_v4_3"
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/julia_v4_3/interface"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/julia_v4_3/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/julia_v4_3/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/julia_v4_3/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
