 ...
 * julia_v4_3_api.c
 *
 * Code generation for function 'julia_v4_3_api'
 *
...
static emlrtRTEInfo b_emlrtRTEI = { 1, 1, "julia_v4_3_api", "" };
...
void julia_v4_3_api(emlrtStack *sp, const mxArray * const prhs[3], const mxArray
                    *plhs[2])
{
  emxArray_creal_T *vz;
  ...
  julia_v4_3(sp, vz, c, maxiter, iter);
...
/* End of code generation (julia_v4_3_api.c) */
